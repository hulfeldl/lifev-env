...
export INSTALLS_DIR=/development/install
...
export CMAKE_INSTALL_DIR=${INSTALLS_DIR}
...
export BOOST_INSTALL_DIR=${INSTALLS_DIR}
...
export OPENBLAS_INSTALL_DIR=${INSTALLS_DIR}
...
export METIS_INSTALL_DIR=${INSTALLS_DIR}
...
export PARMETIS_INSTALL_DIR=${INSTALLS_DIR}
...
export HDF5_INSTALL_DIR=${INSTALLS_DIR}
...
export SUITESPARSE_INSTALL_DIR=${INSTALLS_DIR}
