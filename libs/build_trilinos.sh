...
PARMETIS_INCLUDE_DIR=${PARMETIS_INCLUDE_DIR}/parmetis-3.2.0
${CMAKE_BIN} -D CMAKE_BUILD_TYPE=${BUILD_TYPE} \
      ...
      -D METIS_INCLUDE_DIRS:PATH=${PARMETIS_INCLUDE_DIR} \
      -D METIS_LIBRARY_DIRS:PATH=${PARMETIS_LIB_DIR} \
      -D TPL_METIS_LIBRARIES:PATH=${PARMETIS_LIB_DIR} \
      -D TPL_METIS_INCLUDE_DIRS:PATH=${PARMETIS_INCLUDE_DIR}/../metis-4.0 \
      -D TPL_ParMETIS_LIBRARIES:PATH="$PARMETIS_LIB_DIR/libparmetis.a;$PARMETIS_LIB_DIR/libmetis.a" \
      ...
      -D TPL_AMD_INCLUDE_DIRS:PATH=${SUITESPARSE_INCLUDE_DIR} \
      -D UMFPACK_INCLUDE_DIRS:PATH=${SUITESPARSE_INCLUDE_DIR} \
      -D UMFPACK_LIBRARY_DIRS:PATH=${SUITESPARSE_LIB_DIR} \
      -D TPL_UMFPACK_INCLUDE_DIRS:PATH=${SUITESPARSE_INCLUDE_DIR} \
      ${SOURCE_DIR}
...
# build and install
make verbose=1 -j${NUM_PROC} install
